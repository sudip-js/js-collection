                                                ...
                                                <div className="grid grid-cols-2 gap-x-4">
                                                    {category.featured.map((item) => (
                                                        <div key={item.name} className="group relative text-sm">
                                                            ...
                                                            <div onClick={() => navigate(item?.href, { state: { category_id: item?.id } })} className=" cursor-pointer mt-6 block font-medium text-gray-900">
                                                        ...
                                                        >
                                                            {section.items.map((item) => (
                                                                <li key={item.name} className="flow-root">
                                                                    <div onClick={() => navigate(item?.href, { state: { category_id: item?.id } })} className="-m-2 block p-2 text-gray-500 cursor-pointer">
                                                                        {item.name}
                                                                    </div>
                                                                </li>
                                                            ))}
                                                                        ...
                                                                        <div className="col-start-2 grid grid-cols-2 gap-x-8">
                                                                            {category.featured.map((item) => (
                                                                                <div key={item.name} className="group relative text-base sm:text-sm">
                                                                                    ...
                                                                                    <div onClick={() => navigate(item?.href, { state: { category_id: item?.id } })} className="mt-6 block font-medium text-gray-900 cursor-pointer">
                                                                                        <span className="absolute inset-0 z-10" aria-hidden="true" />
                                                                                        {item.name}
                                                                                    </div>
                                                                                    <p aria-hidden="true" className="mt-1">
                                                                                    ...
                                                                                    >
                                                                                        {section.items.map((item) => (
                                                                                            <li key={item.name} className="flex">
                                                                                                <div onClick={() => navigate(item?.href, { state: { category_id: item?.id } })} className="hover:text-gray-800 cursor-pointer">
                                                                                                    {item.name}
                                                                                                </div>
                                                                                            </li>
                                                                                        ))}
